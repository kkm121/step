...
public class testactivity8 {
    public static void main(String[] args) {
        ...
        Account savings = new SavingsAccount(2001, "Savings User", 25, 10000.0);
        try {
        ...
        Account current = new CurrentAccount(2002, "Current User", 30, 10000.0);
        try {
        ...
        Account fixedDeposit = new FixedDepositAccount(2003, "Fixed Deposit User", 35, 10000.0, 12, 6.5);
        try {
